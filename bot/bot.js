...
const ANDROID_APK_URL=String(process.env.ANDROID_APK_URL||"https://github.com/yaminuchiha1245-png/UCHIHA/releases/download/game-zone-client-v3.1.0/Game-Zone-Client-v3.1.0.apk").trim();
