...
const migrations = [
  ...
  { version: "023_platform_account_core", url: new URL("../migrations/023_platform_account_core.sql", import.meta.url), postgresOnly: true },
  { version: "024_platform_catalog_deposits", url: new URL("../migrations/024_platform_catalog_deposits.sql", import.meta.url), postgresOnly: true },
  { version: "025_ai_bot_product", url: new URL("../migrations/025_ai_bot_product.sql", import.meta.url), postgresOnly: true },
  { version: "026_ai_bot_webhook_idempotency", url: new URL("../migrations/026_ai_bot_webhook_idempotency.sql", import.meta.url), postgresOnly: true },
  { version: "027_ai_bot_usage_limits", url: new URL("../migrations/027_ai_bot_usage_limits.sql", import.meta.url), postgresOnly: true },
  { version: "028_ai_bot_telegram_admin", url: new URL("../migrations/028_ai_bot_telegram_admin.sql", import.meta.url), postgresOnly: true },
  { version: "029_ai_bot_end_user_audit", url: new URL("../migrations/029_ai_bot_end_user_audit.sql", import.meta.url), postgresOnly: true },
  { version: "030_ai_bot_openai_key_reuse", url: new URL("../migrations/030_ai_bot_openai_key_reuse.sql", import.meta.url), postgresOnly: true },
  { version: "031_ai_bot_catalog_launch_copy", url: new URL("../migrations/031_ai_bot_catalog_launch_copy.sql", import.meta.url), postgresOnly: true },
  { version: "032_ai_bot_telegram_identity_unique", url: new URL("../migrations/032_ai_bot_telegram_identity_unique.sql", import.meta.url), postgresOnly: true },
  { version: "033_ai_bot_prompt_leases", url: new URL("../migrations/033_ai_bot_prompt_leases.sql", import.meta.url), postgresOnly: true },
  { version: "034_wallet_proof_admin_bot", url: new URL("../migrations/034_wallet_proof_admin_bot.sql", import.meta.url), postgresOnly: false },
  { version: "035_wallet_proof_admin_bot_rls", url: new URL("../migrations/035_wallet_proof_admin_bot_rls.sql", import.meta.url), postgresOnly: true },
  { version: "036_tenant_store_suspension_guard", url: new URL("../migrations/036_tenant_store_suspension_guard.sql", import.meta.url), postgresOnly: true },
  { version: "037_tenant_activation_subscription_guard", url: new URL("../migrations/037_tenant_activation_subscription_guard.sql", import.meta.url), postgresOnly: true },
  { version: "038_subscription_renewal_price_guard", url: new URL("../migrations/038_subscription_renewal_price_guard.sql", import.meta.url), postgresOnly: true },
  { version: "039_public_store_requires_active_tenant", url: new URL("../migrations/039_public_store_requires_active_tenant.sql", import.meta.url), postgresOnly: true },
  { version: "040_tenant_bot_connection_guard", url: new URL("../migrations/040_tenant_bot_connection_guard.sql", import.meta.url), postgresOnly: true },
...
async function runMigrations(pool, config) {
  ...
  try {
    ...
    if (migrationLockHeld) {
      try { await client.query("SELECT pg_advisory_unlock(hashtext($1))", [MIGRATION_LOCK_NAME]); } catch { /* connection may be unusable */ }
    }
    client.release();
  }
}
...
export async function createDatabase(config) {
  ...
  try { await runMigrations(pool, config); }
  ...
  return {
    ...
    async status() {
      ...
      const result = await pool.query(
        `SELECT COUNT(*) AS migration_count, BOOL_OR(version = $1) AS latest_migration_applied FROM schema_migrations`,
    ...
    async transaction(callback, tenantId = null) {
      ...
      try {
        await client.query("BEGIN");
        if (tenantId && config.databaseMode === "postgres") await client.query("SELECT set_config('app.tenant_id', $1, TRUE)", [tenantId]);
