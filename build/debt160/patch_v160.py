#!/usr/bin/env python3
"""Overlay the real v1.5.10 digital store onto the approved v1.4.5 debt app."""
...
def main() -> None:
    if len(sys.argv) != 2:
        raise SystemExit("usage: patch_v160.py <debt-app>")
    ...
    hero_target = app / "app" / "src" / "main" / "assets" / "digital-hero-v160.webp"
...
'''
    ...
    build = build.replace("versionCode 1040500", "versionCode 1051000", 1)
    build = build.replace("versionName '1.4.5'", "versionName '1.5.10'", 1)
