/* UCHIHA Debt Store v1.4.8 — real digital products module. */
(function(){'use strict';
const VERSION='1.4.8';
...
const errorText=e=>({SESSION_REQUIRED:'فعّل التطبيق أولًا.',LICENSE_INACTIVE:'الخدمة موقوفة.',PROVIDER_NOT_CONFIGURED:'لم يتم ربط متجر جاسر كارد بعد.',INVALID_PROVIDER_TOKEN:'توكن جاسر كارد مرفوض من المزود.',PROVIDER_UNAVAILABLE:'تعذر الاتصال بجاسر كارد حاليًا.',INSUFFICIENT_BALANCE:'رصيدك غير كافٍ لإتمام الطلب.',INVALID_PROOF:'صورة إثبات التحويل غير صالحة أو كبيرة.',INVALID_AMOUNT:'المبلغ غير صحيح.',ALREADY_REVIEWED:'تمت مراجعة هذا الطلب مسبقًا.',FORBIDDEN:'هذه الصفحة مخصصة للإدارة.',TIMEOUT:'الاتصال أخذ وقتًا أطول من المتوقع. حاول مجددًا.',NATIVE_REQUIRED:'حدّث التطبيق إلى النسخة الجديدة.'})[e]||'حدث خطأ. حاول مرة أخرى.';
...
window.DigitalStore={
  async open(){
    ...
    mode='store';path=[];query='';catalog={categories:[],products:[]};drawerOpen=false;loading=true;storeScreen();
