/* UCHIHA Debt Store v1.5.7 — corrected SMM app panel and default catalog. */
(function(){'use strict';
const VERSION='1.5.7';
...
function smmOrderForm(){
  if(!smm.platform){smm.platform={key:'all',name:'الكل',sx:0,sy:0};smm.sections=[...(smm.rootCategories||[])];smm.sectionOptions=[...smm.sections];smm.products=[...(smm.rootProducts||[])];}
...
function hero(){
  return '<section class="digital-hero"><img class="digital-hero-real" src="digital-hero-v157.webp" alt=""><div class="digital-hero-shade"></div><div class="digital-hero-copy"><b><em>DIGITAL</em><br>WORLD<br>WITH <em>UCHIHA</em></b><span>كل ما تحتاجه في مكان واحد</span></div></section>';
}
function topupModal(){
  if(!topupOpen)return'';
