#!/usr/bin/env python3
"""Overlay the real v1.5.7 digital store onto the approved v1.4.5 debt app."""
...
def main() -> None:
    if len(sys.argv) != 2:
        raise SystemExit("usage: patch_v157.py <debt-app>")
    ...
    hero_target = app / "app" / "src" / "main" / "assets" / "digital-hero-v157.webp"
    if hero_source.is_file():
        shutil.copy2(hero_source, hero_target)

    sprite_b64 = repo_root / "build" / "debt156" / "assets" / "smm-icons-v156.webp.b64"
    sprite_target = app / "app" / "src" / "main" / "assets" / "smm-icons-v157.webp"
...
'''
    ...
    build = build.replace("versionCode 1040500", "versionCode 1050700", 1)
    build = build.replace("versionName '1.4.5'", "versionName '1.5.7'", 1)
