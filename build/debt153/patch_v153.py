#!/usr/bin/env python3
"""Overlay the real v1.5.3 digital store onto the approved v1.4.5 debt app."""
...
def main() -> None:
    if len(sys.argv) != 2:
        raise SystemExit("usage: patch_v153.py <debt-app>")
...
'''
    ...
    build = build.replace("versionCode 1040500", "versionCode 1050300", 1)
    build = build.replace("versionName '1.4.5'", "versionName '1.5.3'", 1)
